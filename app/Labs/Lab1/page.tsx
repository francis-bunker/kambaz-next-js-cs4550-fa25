export default function Lab1() {
  return (
    <div id="wd-lab1">
      <h1>Labs Francis Bunker CS4550</h1>
      <h2>Lab 1</h2>
      <h3>HTML Examples</h3>
      <div id="wd-h-tag">
        <h4>Heading Tags</h4>
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          <li>crack 3 eggs in a bowl</li>
          <li>wisk eggs</li>
          <li>put eggs in hot oil or butter on a pan</li>
          <li>stir eggs until cooked</li>
          <li>put eggs on plate</li>
      ...
      <div id="wd-images">
        ...
        <img id="wd-starship" width={400} src="https://www.staradvertiser.com/wp-content/uploads/2021/08/web1_Starship-gap2.jpg" />
        <br />
        Loading a local image:
        <br />
        <img id="wd-teslabot" src="/images/teslabot.jpg" height={200} />
      </div>
      <div id="wd-forms">
        <h4>Form Elements</h4>
